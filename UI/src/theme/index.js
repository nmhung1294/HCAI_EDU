...
shadows: [
    ...
    '0px 24px 48px rgba(15, 23, 42, 0.11)',
    '0px 28px 56px rgba(15, 23, 42, 0.12)',
    '0px 32px 64px rgba(15, 23, 42, 0.13)',
    '0px 36px 72px rgba(15, 23, 42, 0.14)', 
    '0px 40px 80px rgba(15, 23, 42, 0.15)',
    '0px 44px 88px rgba(15, 23, 42, 0.16)',
    '0px 48px 96px rgba(15, 23, 42, 0.17)',
    '0px 52px 104px rgba(15, 23, 42, 0.18)',
    '0px 56px 112px rgba(15, 23, 42, 0.19)',
    '0px 60px 120px rgba(15, 23, 42, 0.20)',
    '0px 64px 128px rgba(15, 23, 42, 0.21)',
    '0px 68px 136px rgba(15, 23, 42, 0.22)',
    '0px 72px 144px rgba(15, 23, 42, 0.23)',
    '0px 76px 152px rgba(15, 23, 42, 0.24)',
    '0px 80px 160px rgba(15, 23, 42, 0.25)',
    '0px 84px 168px rgba(15, 23, 42, 0.26)',
    '0px 88px 176px rgba(15, 23, 42, 0.27)',
    '0px 92px 184px rgba(15, 23, 42, 0.28)',
],
  components: {
    MuiButton: {
      styleOverrides: {
